...
CLAIMS = [
    {"_id": "claim_cool_roof_temp", "documentId": "doc_cool_roof_01", "type": "causal", "statement": "Cool roofs reduce surface temperatures by 10-15°C and ambient air temperatures by 0.5-2°C", "variables": ["v_cool_roof", "v_surface_albedo", "v_uhi_intensity"], "direction": "negative", "confidence": 0.9, "evidenceStrength": "strong", "uncertaintyLanguage": []},
    {"_id": "claim_cool_roof_energy", "documentId": "doc_cool_roof_01", "type": "outcome", "statement": "Energy savings from reduced cooling loads range from 10-30% depending on building type", "variables": ["v_cool_roof", "v_energy_cooling"], "direction": "negative", "confidence": 0.85, "evidenceStrength": "strong", "uncertaintyLanguage": ["depending on"]},
    {"_id": "claim_cool_roof_diminish", "documentId": "doc_cool_roof_01", "type": "mechanism", "statement": "Cool roof effectiveness shows diminishing returns above 60% coverage in tropical climates", "variables": ["v_cool_roof", "v_surface_albedo"], "direction": "positive", "confidence": 0.75, "evidenceStrength": "moderate", "uncertaintyLanguage": ["diminishing"]},
    {"_id": "claim_tree_cool", "documentId": "doc_tree_canopy_02", "type": "causal", "statement": "Urban tree canopy reduces local air temperatures by 1-5°C and radiant heat exposure by 20-40%", "variables": ["v_tree_canopy", "v_uhi_intensity", "v_thermal_comfort"], "direction": "negative", "confidence": 0.8, "evidenceStrength": "strong", "uncertaintyLanguage": []},
    {"_id": "claim_tree_humid", "documentId": "doc_tree_canopy_02", "type": "mechanism", "statement": "Increased tree cover in poorly ventilated urban canyons can trap humidity, reducing thermal comfort", "variables": ["v_tree_canopy", "v_humidity", "v_thermal_comfort"], "direction": "negative", "confidence": 0.7, "evidenceStrength": "moderate", "uncertaintyLanguage": ["can", "potentially"]},
    {"_id": "claim_albedo_uhi", "documentId": "doc_urban_albedo_03", "type": "causal", "statement": "Increasing urban surface albedo reduces UHI intensity by 0.3-1.2°C city-wide", "variables": ["v_surface_albedo", "v_uhi_intensity"], "direction": "negative", "confidence": 0.85, "evidenceStrength": "strong", "uncertaintyLanguage": []},
    {"_id": "claim_albedo_combined", "documentId": "doc_urban_albedo_03", "type": "intervention", "statement": "Combined albedo and vegetation strategies achieve 2-4°C reduction in peak temperatures", "variables": ["v_surface_albedo", "v_tree_canopy", "v_uhi_intensity"], "direction": "negative", "confidence": 0.8, "evidenceStrength": "moderate", "uncertaintyLanguage": []},
    {"_id": "claim_ac_feedback", "documentId": "doc_energy_feedback_04", "type": "mechanism", "statement": "Urban heat increases cooling energy consumption by 1.5-3% per degree Celsius, creating a feedback loop", "variables": ["v_uhi_intensity", "v_energy_cooling"], "direction": "positive", "confidence": 0.75, "evidenceStrength": "moderate", "uncertaintyLanguage": ["can amplify"]},
    {"_id": "claim_ac_amplify", "documentId": "doc_energy_feedback_04", "type": "outcome", "statement": "AC exhaust can amplify initial temperature increases by 10-25% in dense commercial districts", "variables": ["v_energy_cooling", "v_uhi_intensity"], "direction": "positive", "confidence": 0.6, "evidenceStrength": "weak", "uncertaintyLanguage": ["can"]},
]
